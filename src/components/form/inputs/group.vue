                ...
                <template #item="{element, index}">
                    <ux-panel ref="row">
                        ...
                        <ux-panel-body @keydown.enter="enterPress($event)" v-show="!collapsible || !element.collapsed">
                            <ux-form :trail="trail" ref="form" :includeOfficeOnly="includeOfficeOnly" :submission="submission" @form:state="stateChange" :parentModel="parentModel" v-model="model[index]" :flex="sameLine" :fields="field.fields" />
                        </ux-panel-body>
                    </ux-panel>
                </template>
            </draggable>
        ...
        <template v-else>
            ...
            <ux-panel ref="row" v-for="(element, index) in model">
                ...
                <ux-panel-body @keydown.enter="enterPress($event)" v-show="!element.collapsed">
                    <ux-form ref="form" :trail="trail" :includeOfficeOnly="includeOfficeOnly" :submission="submission" @form:state="stateChange" :parentModel="parentModel" v-model="model[index]" :flex="sameLine" :fields="field.fields" />
                </ux-panel-body>
            </ux-panel>
        </template>
        ...
        <template v-if="widget === 'form'">
            <template v-if="model">
                <ux-panel v-if="minimum === 0">
                    ...
                    <ux-panel-body>
                        <ux-form ref="form" :trail="trail" :includeOfficeOnly="includeOfficeOnly" :submission="submission" @form:state="stateChange" :parentModel="parentModel" v-model="model" :flex="sameLine" :fields="field.fields" />
                    </ux-panel-body>
                </ux-panel>
                <ux-form v-else ref="form" :trail="trail" :includeOfficeOnly="includeOfficeOnly" :submission="submission" @form:state="stateChange" :parentModel="parentModel" v-model="model" :flex="sameLine" :fields="field.fields" />
