<template>
    <div class="scope-select" :class="classes">
        ...
        <!-- <div class="ui-select-button" v-if="singleValue"> -->
            <scope-select-button :type="contextReferenceType" :action="contextReferenceAction" v-model="model" />
        <!-- </div> -->
...
import ScopeSelectButton from '../../scope/ScopeSelectButton.vue';
